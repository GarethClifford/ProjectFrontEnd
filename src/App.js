  ...
  render() {
    ...
    <div >
     <div className="App-navbar container" style={{overflow:'auto'}}>
      ...
      <div className="App-button1 col-xs-6" style={{position:'absolute',top:'30%', left:'25%', font:'5vw' }} >
      ...
      <div className="App-button2 col-xs-6" style={{position:'absolute', top:'30%', left:'45%'}}>
        <GetRecipes />
        <br/>
        <GetUsers />
        <br/>
