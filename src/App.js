...
class App extends Component {
  render() {
    return (
    <div >
     <div className="App-navbar container" style={{overflow:'auto'}}>
      <img src={home} className="App-logo" alt="logo" />
      <h1 style={{ position:'absolute', top:'5%', left:'25%' }}> My Personal Project <Homepage /> </h1>
      <div style={{paddingleft: '6px'}}>
      <div className="App-button1 col-md-6" style={{position:'absolute',top:'30%', left:'25%', font:'5vw' }} >
      ...
      <div className="App-button2 col-md-6" style={{position:'absolute', top:'30%', left:'45%'}}>
        <GetRecipes />
        <br/>
        <GetUsers />
        <br/>
